...
<div class="row">
    <div class="col-md-3">
        <div class="card">
            <h4 class="mt-2 card-title ms-4">Assign engineer</h4>
            <hr>
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div lass="form-group">
                                ...
                                <select name="engineer_id" id="engineer_id" class="mb-3 form-select form-select-sm bg-secondary text-light" required>
                                ...
                                @if ($engineers->count() < 1) <a href="{{ route('engineer.create') }}" class="mb-2 btn btn-sm btn-info">+ Add
                                    Engineer</a>
                                    @endif
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Date</label>
                                <input type="date" name="date" required class="form-control text-light" min="{{ date('Y-m-d') }}" max="{{ Carbon::now()->addDays(15)->format('Y-m-d') }}" required>
                            </div>
                            @error('date')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
